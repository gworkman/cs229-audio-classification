...
if __name__ == '__main__':
    ...
    plt.suptitle('CNN Training Performance (Pronunciations)')
    plt.savefig('../images/pinyin_cnn_training.png')
    ...
    plt.savefig(f'../images/cnn_confusion_pinyin.png')

    model.save('./cnn-pinyin')
